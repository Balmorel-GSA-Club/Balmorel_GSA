...
SCALAR IOF1_      'Multiplier 1 (used with QOBJ and derivation of marginal values)'   /1/;
...
execute_load '../scenario_data/input_data/input_data_%id%.gdx', FUELPRICE, GDATA_numerical, EMI_POL, CCS_CO2CAPTEFF_G, XINVCOST, XH2INVCOST, DE, SUBTECHGROUPKPOT, HYDROGEN_DH2, EV_BEV_available, BEV_TECH_DATA, DR_ADOPTIONRATE, DR_DATA;     
...
execute_unload '../scenario_data/input_data/input_data_%id%.gdx', FUELPRICE, GDATA_numerical, EMI_POL, CCS_CO2CAPTEFF_G, XINVCOST, XH2INVCOST, DE, SUBTECHGROUPKPOT, HYDROGEN_DH2, EV_BEV_available, BEV_TECH_DATA, DR_ADOPTIONRATE, DR_DATA;
